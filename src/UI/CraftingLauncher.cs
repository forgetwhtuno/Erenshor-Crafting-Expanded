...
namespace ErenshorCraftingExpanded
{
    internal sealed class CraftingLauncher
    {
        ...
        internal void Initialize(float x, float y, Action<float, float> persist, Action toggle)
        {
            Dispose();
            _toggle = toggle;
            _root = RetainedUiKit.CreateCanvas("ErenshorCraftingLauncherCanvas", 510);
            RectTransform canvas = _root.GetComponent<RectTransform>();
            _panel = RetainedUiKit.CreateRect("CraftingLauncher", canvas);
            ...
            grip.anchorMin = Vector2.zero; grip.anchorMax = new Vector2(0f, 1f); grip.pivot = Vector2.zero;
            grip.anchoredPosition = Vector2.zero; grip.sizeDelta = new Vector2(20f, 0f);
        ...
        internal void Dispose()
        {
            ...
            _panel = null; _label = null; _position = null; _toggle = null;
        }
    }
}
